...
|developer=Aeomin
|version=2.5.4.18 / September 18, 2009<br>2.6.2.66 / August 1, 2011
|os=Windows 2000/XP/Vista/7
|lang=Multiple (6)
|type=Patch Client
|license=unknown (closed source)
|web=http://thor.aeomin.net/}}
[[Thor Patcher]] is designed with the client-side config file embed ''inside'' the patcher itself. Since it uses no extra DLLs, you may distribute 1 file to your players. This guide will not discuss how to setup a [[wikipedia:Web_Server|Web Server]].
...
# '''Background''' (''This is the main part of a skin'')
#* supported formats
#** jpg (no transparency)
...
#* Custom Buttons:
#: see [[#Custom Buttons|guide]]
# '''Custom Notice Box''':
#: see [[#Custom Notice Box|guide]]
# '''Progressbar''' (''Shows the patching progress'')
#* Supported formats when use image based progress bar
#** bmp
#** jpg (crashes on 2.6.1.66)
#** png (crashes on 2.6.1.66)
# '''Status message''' (''Displays the patcher status'')
...
==[Config:Main]==
*RootURL='<nowiki>http://domain.com/patch/</nowiki>'
...
*URL='<nowiki>http://domain.com/patch/notice.html</nowiki>'
...
*Action='<nowiki>http://example.com</nowiki>'
...
The langauge.ini is a fast way to switch your patcher's langauge without having to change the config file.
It contains the same configuration lines as the language part of the config.ini
...
* file_url=<nowiki>http://domain.com/patch/data/</nowiki>
** the URL where you plan to save your patches in
*** supports both HTTP and FTP
**** HTTP: use the following format:
***** <nowiki>http://domain.com/dir/</nowiki>
**** FTP : 
***** connecting as anonymous:
****** <nowiki>ftp://domain.com/dir/</nowiki>
***** connecting with user & pass:
****** <nowiki>ftp://username:password@domain.com:port/dir/</nowiki>
...
==External Links==
* [http://thor.aeomin.net/ Official Thor Patcher Homepage]
* [http://www.eathena.ws/board/index.php?showtopic=171632 Official Thor Patcher Thread]
