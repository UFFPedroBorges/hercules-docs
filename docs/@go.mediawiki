...
If you want your map to show up in @go when you do @go, you would need to add it to one more file and this file is called the [https://github.com/HerculesWS/Hercules/blob/master/conf/help.txt help.txt]. You can find such file by heading to .../conf/help.txt. Search for '''go:''' so that you can find this code:
