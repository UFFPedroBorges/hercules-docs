{{infobox/software
|caption=Triad Patcher
|heading=[[Image:triad-oobe.png|250px]]<br>Triad Patcher out of the box after basic configuration.
|developer=Di Vincenzo Mikaël
|version=1.3.0.3 / June 22, 2006
|os=Windows
|lang=French, English
|type=Patch Client
|license=unknown (closed source)
|web=http://triad.nitroconcept.net/}}
...
All mentioned configuration files follow the schematics of an [http://en.wikipedia.org/wiki/INI_file INI file].
...
;bmpskin_file
:Sets a file to be used as skin. Magenta ({{color|ff00ff}}) is used as transparency color. Position of skin elements is defined in section ''skinmap''.
;banner_width
...
All color values are written as hexadecimal [http://en.wikipedia.org/wiki/RGB RGB] color values in format RRGGBB. For example full red being written as FF0000.
...
====Example====
<!-- myro.org is fictive server, not existing at the time when this example was written -->
 <nowiki>[baseoptions]</nowiki>
 language = english
 about_lang = 1
 about_header = MyRO.ORG (<nowiki>http://myro.org/</nowiki>)
 bmpskin_path =
 ...
 <nowiki>[urls]</nowiki>
 news = <nowiki>http://myro.org/p/news.htm</nowiki>
 register = <nowiki>http://myro.org/register/</nowiki>
 patchs_list = <nowiki>http://myro.org/p/patchlist.ini</nowiki>
 exec_file = myro.exe
 exec_args =
 
 <nowiki>[skinmap]</nowiki>
 body_left = 0
 body_top = 0
 body_width = 545
 body_height = 469
...
====Example====
 ...
 <nowiki>[patchs]</nowiki>
 ; fix for bards looking strange with some cloth colors
 <nowiki>http://myro.org/patches/2010-09-21palettefix.tpp</nowiki> = 1
 ; disabled, because it is broken
 <nowiki>http://myro.org/patches/2010-09-22newclient.tpp</nowiki> = 0
 ; fix for crash in party window
 <nowiki>http://myro.org/patches/2010-09-25newclient.tpp</nowiki> = 1
...
==External Links==
* [http://triad.nitroconcept.net/ Official Triad Patcher Homepage (French)]
* [http://triad.nitroconcept.net/index_eng.php Official Triad Patcher Homepage (English)]
