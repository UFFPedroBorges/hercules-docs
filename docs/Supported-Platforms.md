...
| System                         | Support Status    | Primary platform until  | Supported until         |
| ------------------------------ | ----------------- | ----------------------- | ----------------------- |
| Ubuntu 22.10 Kinetic Kudu      | *unknown*         |                         |                         |
| Ubuntu 22.04 Jammy Jellyfish   | **primary**       | April 2024 (rel. 24.04) | October 2024            |
| Ubuntu 21.10 Impish Indri      | *unsupported*     |                         |                         |
| Ubuntu 21.04 Hirsute Hippo     | *unsupported*     |                         |                         |
| Ubuntu 20.10 Groovy Gorilla    | *unsupported*     |                         |                         |
| Ubuntu 20.04 Focal Fossa       | supported         |                         | October 2022            |
...
| FreeBSD 13.1  | **primary**     | release of version 14  | 13.2 release + 3 months, or release of version 15     |
| FreeBSD 13.0  | *unsupported*   |                        |                                                       |
| FreeBSD 12.x  | supported (1)   |                        | last 12.x release + 2 years, or release of version 14 |
| FreeBSD 12.3  | supported       |                        | December 2023 (expected), or release of version 14    |
...
The last version of macOS is a primary platform, assuming the latest version of Xcode is installed (or GCC through Homebrew). The previous versions are supported platforms onyl for as long as they are maintained upstream. Only autotools builds are tested and actively maintained. Apple Silicon builds are currently untested.

| System                     | Support Status | Primary platform until   | Supported until                  |
| -------------------------- | -------------- | ------------------------ | -------------------------------- |
| macOS 13 Ventura (x86_64)  | *unknown*      |                          |                                  |
| macOS 13 Ventura (aarch64) | *unknown*      |                          |                                  |
| macOS 12 Monterey (x86_64) | **primary**    | release of version 13    | release of version 15 (expected) |
| macOS 12 Monterey (aarch64)| *unknown*      |                          |                                  |
| macOS 11 Big Sur (x86_64)  | supported      |                          | release of version 14 (expected) |
| macOS 11 Big Sur (aarch64) | *unknown*      |                          |                                  |
| macOS 10.15 Catalina       | supported      |                          | release of version 13 (expected) |
...
| System      | Support Status | Primary platform until | Supported until        |
| ----------- | -------------- | ---------------------- | ---------------------- |
| OpenBSD 7.1 | supported      |                        | release of version 7.2 |
...
Windows (workstation versions) are primary platform, for as long as they're within their upstream Mainstream Support period. Versions (workstation and server versions) within their upstream Extended Support period are supported. Older versions are unsupported.
Primary support for more than one version of Windows won't be guaranteed in any case. As such, when a new version is released, the current primary supported version may switch to supported.
...
| System                     | Support Status | Primary platform until | Supported until         |
| -------------------------- | -------------- | ---------------------- | ----------------------- |
| Windows Server 2022        | supported      | 2026-10-13             | 2031-10-14              |
| Windows Server v.20H2      | *unsupported*  |                        |                         |
| Windows Server v.2004      | *unsupported*  |                        |                         |
...
| Windows 11 v.22H2          | *unknown*      |                        | 24 months since release |
| Windows 11 v.21H2          | **primary**    | next update            | 2023-10-10              |
| Windows 10 (latest)        | supported      |                        | 2025-10-14              |
| Windows 10 v.22H2          | *unknown*      |                        | 18 months since release |
...
| Windows 8.1                | *unsupported*  |                        | 2023-01-10              |
...
| -------------------------------- | -------------- | ---------------------------- | ----------------------------- |
| Visual Studio 2022 Version 17.2  | **primary**    | next release                 | 2032-01-13 or next 3 releases |
| Visual Studio 2022 Version 17.1  | *unsupported*  |                              |                               |
